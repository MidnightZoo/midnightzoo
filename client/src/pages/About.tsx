...
const equipment = [
  {
    category: "Telescopes",
    items: [
      "William Optics RedCat 61 (APO refractor)",
      "Askar SQA55 (quintuplet astrograph)",
      "Apertura CarbonStar 200 (8\" Newtonian)",
      "Celestron 8\" EdgeHD (SCT)",
      "William Optics UltraCat 108 (APO refractor)",
      "William Optics 30mm guide scope",
      "Apertura 30mm guide scope",
      "Rokinon 135mm f2.0 lens (wide-field)",
      "Canon RF 24mm f/1.4 VCM L (wide-field)",
    ],
  },
  {
    category: "Cameras",
    items: [
      ...
      "ZWO ASI6200MM Pro (monochrome)",
      "ZWO ASI4400MC (color)",
      "ZWO ASI676MC (color/planetary)",
      "ZWO ASI585 Pro (color, Air version)",
      "QHY mini mono (SCT imaging)",
      "Canon R5 Mark II (wide-field/landscape)",
  ...
  },
  {
    category: "Mounts",
    items: [
      "10Micron GM1000 HPS (premium)",
      "iOptron CEM70 EC2 (dual-encoder)",
      "ZWO AM5N (strain-wave)",
      "ZWO AM3 (strain-wave, travel)",
      "Sky-Watcher GTi (travel)",
    ],
  },
  {
    category: "Filters",
    items: [
      ...
      "Optolong 3nm Ha, OIII, SII (narrowband)",
      "QHY 3nm Ha, OIII, SII (narrowband)",
      "Baader LRGB (broadband)",
      "QHY LRGB (broadband)",
      "Optolong L-Ultimate (dual-band)",
      "Optolong L-eXtreme (dual-band)",
      "Optolong L-Quad Enhance (quad-band)",
      "Optolong L-Synergy (dual-band)",
      "QHY planetary filter set",
    ],
  },
  {
    category: "Software",
    items: [
      "NINA (capture & sequencing)",
      "PixInsight (primary processing)",
      "Photoshop (finishing)",
      "Lightroom Classic (cataloging)",
      "PHD2 (autoguiding)",
      "ASIAIR (mobile capture control)",
    ],
  },
  {
    category: "Accessories",
    items: [
      "ASIAIR Pro (capture controllers)",
      "ASIAIR Mini (capture controllers)",
      "ZWO EAF autofocusers",
      "ZWO CAA rotators",
      "ZWO EFW 7-position filter wheels",
      "ZWO filter drawers",
      "Pegasus Power Box Ultra (power & control)",
      "Off-axis guider (EdgeHD)",
      "Celestron Hyperstar (EdgeHD)",
      "Celestron 0.7x reducer (EdgeHD)",
      "Televue 2x converter",
      "ZWO PR extender",
      "Astrozap dew heater",
      "Deep Sky Dad flat panel (flip-flat)",
