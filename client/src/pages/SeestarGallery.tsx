/* ============================================================
   ...
   Dedicated gallery for ZWO Seestar S50 captures
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                This gallery is dedicated entirely to images captured with the <strong style={{ color: "oklch(0.85 0.01 240)" }}>ZWO Seestar S50</strong> — a compact, all-in-one smart telescope that costs a fraction of a traditional astrophotography rig.
              </p>
              <p
                className="text-base leading-relaxed mb-4"
                style={{ color: "oklch(0.70 0.01 240)", fontFamily: "'Figtree', system-ui, sans-serif" }}
              >
                The Seestar handles alignment, tracking, and stacking automatically from a smartphone app. No prior experience required. No separate mount, camera, or software. Just point and image.
              </p>
              <p
                className="text-base leading-relaxed"
                style={{ color: "oklch(0.70 0.01 240)", fontFamily: "'Figtree', system-ui, sans-serif" }}
              >
                These images are kept separate from the main galleries not because they are lesser — but because they tell a different story. This is what the entry point to astrophotography looks like in 2025. The barrier has never been lower.
              </p>
            </div>
